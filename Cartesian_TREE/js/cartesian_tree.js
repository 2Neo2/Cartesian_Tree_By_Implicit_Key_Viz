...
class Cartesian_Tree {
    constructor(x, y, backgroundColor) {
        ...
        this.root = new Cartesian_Tree_Node(this.graphicsBuffer);
    ...
    addValueFrame(value, complete, ...callbackArgs) {
        if(!this.node.isFilled()) {
            ...
            this.node.paint(Cartesian_Tree_Node.SUCCESS); // Mark this node as inserted
            ...
            this.node.paint(Cartesian_Tree_Node.VISITED); // Mark this node as visited
    ...
    searchFrame(value, complete, ...callbackArgs) {
        if(this.node.color !== Cartesian_Tree_Node.VISITED) {
            // Mark the root node as visited first, then continue the search
            this.root.paint(Cartesian_Tree_Node.VISITED);
            ...
            this.node.paint(Cartesian_Tree_Node.SUCCESS);  // Mark the node as found
            ...
            cutHalf.recursivePaint(Cartesian_Tree_Node.FAILURE);
            cutHalf.draw();

            // Mark the next node as visited
            nextHalf.paint(Cartesian_Tree_Node.VISITED);
