...
class Cartesian_Tree_Node{
    ...
    constructor(graphicsBuffer, parent = null, size = Cartesian_Tree_Node.SIZE,
                 color = Cartesian_Tree_Node.COLOR, stroke = Cartesian_Tree_Node.STROKE,
                 textSize = Cartesian_Tree_Node.TEXTSIZE, textColor = Cartesian_Tree_Node.TEXTCOLOR,
                 edgeColor = Cartesian_Tree_Node.EDGECOLOR,
                 edgeThickness = Cartesian_Tree_Node.EDGETHICKNESS) {
    ...
    ***/
    addValue(value) {
        if (!this.isFilled()) {
            ...
            this.value = value;
            this.leftNode = new Cartesian_Tree_Node(this.graphicsBuffer, this);
            this.rightNode = new Cartesian_Tree_Node(this.graphicsBuffer, this);
            ...
            var initialLeftSpacing = this.leftNode.cumulativeRightSpacing
                + Cartesian_Tree_Node.HORIZONTALSPACING;
    ...
    setCoordinates(x, y) {
        if(this.isFilled()) {
            if(typeof x === "undefined" && typeof y === "undefined") {
                ...
                this.y = this.parent.y + Cartesian_Tree_Node.VERTICALSPACING;
    ...
    ***/
    ...
    resetVisuals() {
        if(this.isFilled()) {
            this.size = Cartesian_Tree_Node.SIZE;
            this.color = Cartesian_Tree_Node.COLOR;
            this.stroke = Cartesian_Tree_Node.STROKE;
            this.textSize = Cartesian_Tree_Node.TEXTSIZE;
            this.textColor = Cartesian_Tree_Node.TEXTCOLOR;

            this.edgeColor = Cartesian_Tree_Node.EDGECOLOR;
            this.edgeThickness = Cartesian_Tree_Node.EDGETHICKNESS;
